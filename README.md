...
We propose a short-baseline laboratory experiment using topological insulators to detect non-local correlations that strictly obey **Topological Addressing** ($\mathcal{C}_{TX} = \mathcal{C}_{RX}$).
